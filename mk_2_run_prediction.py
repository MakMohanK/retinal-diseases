...
# PATH CONFIGURATION
# ===============================
input_folder = r'/home/pi/Desktop/Final Iris/mohan/input'
model_path = r'/home/pi/Desktop/Final Iris/mohan/efficientnet_retina.pth'
test_label_csv = r'/home/pi/Desktop/Final Iris/mohan/RFMiD_Training_Labels.csv'

IMG_SIZE = 224
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# ===============================
# MODEL PREDICTION THERESHOLD 
# ===============================
DISEASE_THRESHOLD = 0.469
...
for img_name in image_files:
    ...
    sorted_preds["Disease_Risk"] = sorted_preds["Disease_Risk"] - DISEASE_THRESHOLD
    print(sorted_preds["Disease_Risk"])
